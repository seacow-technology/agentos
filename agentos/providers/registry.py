...
from agentos.providers.base import Provider, ProviderStatus
...
class ProviderRegistry:
    ...
    def _get_config_manager(self):
        ...
        if self._config_manager is None:
            from agentos.providers.cloud_config import CloudConfigManager
    ...
    def _register_default_providers(self):
        ...
        Sprint B+: Now reads from ~/.agentos/config/providers.json
        Supports multiple instances per provider
        """
        # Import here to avoid circular dependency
        from agentos.providers.local_ollama import OllamaProvider
        from agentos.providers.local_lmstudio import LMStudioProvider
        from agentos.providers.local_llamacpp import LlamaCppProvider
        from agentos.providers.cloud_openai import OpenAIProvider
        from agentos.providers.cloud_anthropic import AnthropicProvider
