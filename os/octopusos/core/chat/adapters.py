    ...
    def generate(
        ...
        **kwargs: Any,
        ...
        try:
            ...
            if "404" in str(e):
                try:
                    prompt_tokens_est = self._estimate_messages_tokens(messages)
                    ...
                    try:
                        if completion_tokens is not None:
                            total_tokens = int(prompt_tokens_est) + int(completion_tokens)
                    except Exception:
                        total_tokens = None
                    return content, {
        ...
        **kwargs: Any,
        ...
        try:
            ...
            metadata = {
                ...
                "tokens_confidence": "HIGH" if hasattr(response, 'usage') else "LOW",
            }
            tool_calls = []
